...
cl -c /O2 /EHsc /MTd /W0 /wd4267 /wd4244 /Fo"jxl_objs/" /D"JPEGXL_ENABLE_TRANSCODE_JPEG=0" /D"JPEGXL_ENABLE_BOXES=0" -I .. -I . -I ../third_party/highway ^
../lib/jxl/dec_ans.cc ^
...
lib jxl_objs/*.obj hwy_objs/*.obj /out:jxl_dec_debug.lib
