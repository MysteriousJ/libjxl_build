...
cd jxl_objs
F:\programs\wasi-sdk-20.0+m\bin\clang -target wasm32-wasi -Oz -mbulk-memory -c -I ../.. -I ../ -I ../../third_party/highway -I ../../third_party/brotli/c/include ^
../../lib/jxl/dec_ans.cc ^
...
cd hwy_objs
F:\programs\wasi-sdk-20.0+m\bin\clang -target wasm32-wasi -Oz -mbulk-memory -c -I ../.. -I ../ -I ../../third_party/highway ^
...
cd brotli_objs
F:\programs\wasi-sdk-20.0+m\bin\clang -target wasm32-wasi -Oz -mbulk-memory -c -I ../.. -I ../ -I ../../third_party/brotli/c/include ^
...
F:\programs\wasi-sdk-20.0+m\bin\ar -rvs jxl_dec.a jxl_objs/*.o hwy_objs/*.o brotli_objs/*.o
