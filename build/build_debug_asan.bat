...
cl -c /O2 /EHsc /MTd /fsanitize=address /W0 /wd4267 /wd4244 /Fo"jxl_objs/" -I .. -I . -I ../third_party/highway -I ../third_party/brotli/c/include ^
../lib/jxl/dec_ans.cc ^
...
cl -c /O2 /EHsc /MTd /fsanitize=address /W0 /wd4267 /Fo"hwy_objs/" -I .. -I . -I ../third_party/highway ^
../third_party/highway/hwy/aligned_allocator.cc ^
../third_party/highway/hwy/per_target.cc ^
../third_party/highway/hwy/targets.cc

cl -c /O2 /EHsc /MTd /fsanitize=address /W0 /wd4267 /Fo"brotli_objs/" -I .. -I . -I ../third_party/brotli/c/include ^
...
lib jxl_objs/*.obj hwy_objs/*.obj brotli_objs/*.obj /out:jxl_dec.lib
