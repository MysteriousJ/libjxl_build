echo "Building jxl"
cd jxl_objs
clang -c -g -arch arm64 -std=c++14  -I ../.. -I ../ -I ../../third_party/highway -I ../../third_party/brotli/c/include \
../../lib/jxl/dec_ans.cc \
...
echo "Building hwy"
cd ../hwy_objs
clang -c -g -arch arm64 -std=c++14  -I ../.. -I ../ -I ../../third_party/highway \
...
cd ../brotli_objs
clang -c -g -arch arm64 -I ../.. -I ../ -I ../../third_party/brotli/c/include \
